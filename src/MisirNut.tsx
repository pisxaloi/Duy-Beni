...
export default function MisirNut({ onBack }: MisirNutProps) {
  const sections = getTextSections(NUT_PAGE.text, 2);
  ...
  const startPlayback = async () => {
    ...
    const audio1 = audioManager.play("/nut1.mp3") as HTMLAudioElement;
    ...
    const onPart1Ended = () => {
      ...
      const audio2 = audioManager.play("/nut2.mp3") as HTMLAudioElement;
